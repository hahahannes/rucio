...
@transactional_session
def set_rse_transfer_limits(rse, activity, rse_id=None, rse_expression=None, max_transfers=0, transfers=0, waitings=0, max_volumn=0, session=None):
    """
    ...
    :param max_volumn: Maximum transfer volumn in bytes.
    :param session: The database session in use.
    ...
    try:
        ...
        rse_tr_limit = models.RSETransferLimit(rse_id=rse_id, activity=activity, rse_expression=rse_expression, max_transfers=max_transfers, transfers=transfers, waitings=waitings, max_volumn=max_volumn)
...
def get_rse_transfer_limits(rse=None, activity=None, rse_id=None, session=None):
    ...
    :returns: A dictionary with the limits {'limit.activity': {'limit.rse_id': {'max_transfers': limit.max_transfers, 'transfers': 0, 'waitings': 0, 'max_volumn': 1}}}.
    """
    try:
